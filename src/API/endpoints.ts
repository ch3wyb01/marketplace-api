export const endpoints = {
  ...
  'PATCH /products/:id': {
    description:
      'accepts an object containing product fields to update and returns the updated product',
    queries: [],
  ...
  'PATCH /categories/:id': {
    description:
      'accepts an object containing category fields to update and returns the updated category',
    queries: [],
    exampleRequest: '/categories/6220f9ab230ed15af3d3dffb',
    exampleRequestBody: {
